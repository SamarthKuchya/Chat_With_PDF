...
def main():
    ...
    with st.sidebar:
        st.title("Menu:")
        pdf_docs = st.file_uploader("Upload your PDF Files ( Which Are Readable By Computers ) and Click on the Submit & Process Button", accept_multiple_files=True)
    ...
    if user_question:
        print(st.session_state.text_chunks)
